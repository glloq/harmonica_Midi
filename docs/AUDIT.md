...
> Rappel de portée : le cœur logique (natif) est couvert par 18 tests unitaires ;
> le chemin ESP32 (HAL réelle, transports sans-fil, serveur web) est **vérifié
> syntaxiquement** (stubs), pas exécuté sur matériel.
...
| 19 | Preset chromatique « à chaud » non fonctionnel sans `slide.enabled` | 🟡 l'UI **avertit** ; ⏳ actionneur slide construit au boot uniquement |
